...
Generated: 2026-07-03T16:56:01+00:00
...
PYTHONPATH=src .venv/bin/python -m rheed2morph.rheed.build_shape_bag_inputs --root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --out-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --mode manual_or_candidates --candidate-count 16 --image-size 256 --seed 42 --debug
...
manifest = Path('reports/rheed_shape_bag_input_mvp/20260703_165110/rheed_shape_bag_manifest.csv')
ds = RHEEDShapeBagDataset(manifest)
print('n=', len(ds))
item = ds[0]
print(item['sample_id'], item['frames'].shape, item['consensus_maps'].shape, item['shape_features'].shape)
PY
```
...
- `src/rheed2morph/rheed/build_shape_bag_inputs.py`
- `src/rheed2morph/rheed/rheed_shape_bag_dataset.py`
- `src/rheed2morph/rheed/models/shape_bag_encoder.py`
- `src/rheed2morph/rheed/pretrain_shape_bag_invariance.py`
- `tests/test_rheed_shape_bag_input.py`
- Per-sample `data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256/<sample_id>/rheed_shape_input/`
- `reports/rheed_shape_bag_input_mvp/20260703_165110/`
...
Perturbations tested: brightness scales, contrast scales, gamma shifts, low-frequency gradient, mild noise, and mild blur. Raw brightness stability and shape-feature stability are summarized in `reports/rheed_shape_bag_input_mvp/20260703_165110/global_exposure_invariance_summary.csv`. Exposure-sensitive feature names are recorded in each sample's `exposure_invariance_audit.json`. A global default stable feature list is written to `reports/rheed_shape_bag_input_mvp/20260703_165110/default_training_feature_names.txt`.

## Geometry Feature Summary

- Frame feature count: 48
- Low-confidence samples: 14
- Component type summary: `reports/rheed_shape_bag_input_mvp/20260703_165110/global_component_type_summary.png`
- High `bar_like_score` examples: `reports/rheed_shape_bag_input_mvp/20260703_165110/global_bar_like_score_examples.png`
- Low-quality examples: `reports/rheed_shape_bag_input_mvp/20260703_165110/global_low_quality_examples.png`

## Output Locations

- Global manifest: `reports/rheed_shape_bag_input_mvp/20260703_165110/rheed_shape_bag_manifest.csv`
- Global feature table: `reports/rheed_shape_bag_input_mvp/20260703_165110/global_sample_shape_features.csv`
- Global overview grid: `reports/rheed_shape_bag_input_mvp/20260703_165110/global_shape_bag_overview.png`
...
manifest = Path("reports/rheed_shape_bag_input_mvp/20260703_165110/rheed_shape_bag_manifest.csv")
ds = RHEEDShapeBagDataset(manifest)
print(len(ds), ds[0]["frames"].shape, ds[0]["shape_features"].shape)
PY
```
