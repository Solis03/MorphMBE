...
Generated: 2026-07-03T16:43:28+00:00
...
Perturbations tested: brightness scales, contrast scales, gamma shifts, low-frequency gradient, mild noise, and mild blur. Raw brightness stability and shape-feature stability are summarized in `reports/rheed_shape_bag_input_mvp/20260703_164312/global_exposure_invariance_summary.csv`. Exposure-sensitive feature names are recorded in each sample's `exposure_invariance_audit.json` and excluded from that sample's audit-recommended feature list.

## Geometry Feature Summary

- Frame feature count: 48
- Low-confidence samples: 0
- Component type summary: `reports/rheed_shape_bag_input_mvp/20260703_164312/global_component_type_summary.png`
- High `bar_like_score` examples: `reports/rheed_shape_bag_input_mvp/20260703_164312/global_bar_like_score_examples.png`
- Low-quality examples: `reports/rheed_shape_bag_input_mvp/20260703_164312/global_low_quality_examples.png`

## Output Locations

- Global manifest: `reports/rheed_shape_bag_input_mvp/20260703_164312/rheed_shape_bag_manifest.csv`
- Global feature table: `reports/rheed_shape_bag_input_mvp/20260703_164312/global_sample_shape_features.csv`
- Global overview grid: `reports/rheed_shape_bag_input_mvp/20260703_164312/global_shape_bag_overview.png`
