...
Generated: 2026-07-03T16:12:24+00:00
...
- `reports/rheed_frame_selection_mvp/20260703_160842/video_inventory.csv`
- `reports/rheed_frame_selection_mvp/20260703_160842/frame_selection_summary.csv`
- `reports/rheed_frame_selection_mvp/20260703_160842/failed_videos.csv`
- `reports/rheed_frame_selection_mvp/20260703_160842/global_candidate_overview_grid.png`
- `reports/rheed_frame_selection_mvp/20260703_160842/sample_quality_histograms.png`
- `reports/rheed_frame_selection_mvp/20260703_160842/codex_report.md`
- `data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256/manual_selected_frame_manifest.csv`
- `data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256/manual_selected_frame_manifest_issues.csv`

## Exact Command

```bash
PYTHONPATH=src .venv/bin/python -m rheed2morph.rheed.select_representative_frames --video-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --out-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --num-candidates 16 --sample-every-n-frames 1 --max-frames-per-video 1200 --display-size 256 --seed 42
```

## Commands Run By Codex

```bash
PYTHONPATH=src .venv/bin/python -m unittest tests/test_rheed_frame_selection.py
PYTHONPATH=src .venv/bin/python -m unittest discover -s tests
PYTHONPATH=src .venv/bin/python -m rheed2morph.rheed.select_representative_frames --video-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --out-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --num-candidates 12 --max-frames-per-video 300 --debug
PYTHONPATH=src .venv/bin/python -m rheed2morph.rheed.select_representative_frames --video-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --out-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --num-candidates 16 --sample-every-n-frames 1 --max-frames-per-video 1200 --display-size 256 --seed 42
PYTHONPATH=src .venv/bin/python -m rheed2morph.rheed.select_representative_frames --video-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --out-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --num-candidates 16 --sample-every-n-frames 1 --max-frames-per-video 1200 --display-size 256 --seed 42
...
- Videos processed successfully: 62
- Failures: 0
- Example video paths:
...
Scores are clipped to `[0, 1]`, with component normalization performed within each video. Critical rejection flags are `almost_black`, `almost_white`, `over_saturated`, `very_low_dynamic_range`, and `strong_shadow`. The requested candidate count is 16 per video, with `min_frame_gap=5` and `min_ssim_distance=0.03`.

## Quality Summary

- Low-confidence videos: 5
- Common failure modes: none
- Shadow, saturation, and blur statistics are summarized in `reports/rheed_frame_selection_mvp/20260703_160842/sample_quality_histograms.png`.
...
- `data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256/N6022 - Copy/frame_selection/candidate_frames_grid.png`
- `data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256/N6023 - Copy/frame_selection/candidate_frames_grid.png`

Global overview grid: `reports/rheed_frame_selection_mvp/20260703_160842/global_candidate_overview_grid.png`
