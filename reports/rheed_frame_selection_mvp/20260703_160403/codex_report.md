...
Generated: 2026-07-03T16:07:44+00:00
...
- `reports/rheed_frame_selection_mvp/20260703_160403/video_inventory.csv`
- `reports/rheed_frame_selection_mvp/20260703_160403/frame_selection_summary.csv`
- `reports/rheed_frame_selection_mvp/20260703_160403/failed_videos.csv`
- `reports/rheed_frame_selection_mvp/20260703_160403/global_candidate_overview_grid.png`
- `reports/rheed_frame_selection_mvp/20260703_160403/sample_quality_histograms.png`
- `reports/rheed_frame_selection_mvp/20260703_160403/codex_report.md`

## Exact Command

```bash
PYTHONPATH=src /home/wangziyi/MorphMBE/MorphMBE/src/rheed2morph/rheed/select_representative_frames.py --video-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --out-root data/rheed_roi_shadow_right_v2_main_raw_crop_videos_256 --num-candidates 16 --sample-every-n-frames 1 --max-frames-per-video 1200 --display-size 256 --seed 42
```
...
- Shadow, saturation, and blur statistics are summarized in `reports/rheed_frame_selection_mvp/20260703_160403/sample_quality_histograms.png`.
...
Global overview grid: `reports/rheed_frame_selection_mvp/20260703_160403/global_candidate_overview_grid.png`
